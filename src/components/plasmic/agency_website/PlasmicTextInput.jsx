...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: qjDN-KLLlNCy/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: omJD4oCHYd-l/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__wvLCh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__iWpxC)}
              role={"img"}
            />
          ),
